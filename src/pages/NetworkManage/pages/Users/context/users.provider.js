...
const NetworkUsersProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (get(network, "id", false))
      dispatch({
        type: "UPDATE_VALUE",
        key: "createUserRoute",
        value: `${pathname}/users/add?parent_id=${get(network, "id")}`
      })
  }, [network, pathname])
...
NetworkUsersProvider.defaultProps = {
  children: null
}

NetworkUsersProvider.propTypes = {
  children: PropTypes.any
}

export default NetworkUsersProvider
