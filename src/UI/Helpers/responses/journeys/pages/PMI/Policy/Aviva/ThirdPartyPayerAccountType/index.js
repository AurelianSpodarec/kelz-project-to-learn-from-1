 ...
 */
export const fakeAvivaThirdPartyPayerAccountTypePageResponse = {
  data: {
    page: {
      key: "AVIVA_THIRD_PARTY_PAYER_ACCOUNT_TYPE",
      stage: "POLICY",
      route: "/journeys/abcde-11111/aviva-third-party-payer-account-type",
      conditionals: [],
      data: { third_party_payer_account_type: "SOLE" }
    },
    journey: {
      id: 999,
      slug: "abcde-11111",
