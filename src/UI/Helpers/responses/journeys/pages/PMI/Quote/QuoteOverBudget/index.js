/**
 * Mock response for /journeys/:journey/quote-over-budget GET
 */
export const fakeJourneyQuoteOverBudgetPageGetResponse = {
  data: {
    page: {
      key: "QUOTE_OVER_BUDGET",
      stage: "QUOTE",
      route: "/journeys/abcde-11111-2/quote-over-budget",
      conditionals: [],
      data: []
    },
    journey: {
